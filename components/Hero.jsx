...
export default function Hero() {
    ...
    return (
        <section ref={ref} className="px-2">
            <div
                className="relative flex items-center bg-black text-white rounded-3xl overflow-hidden"
            >
                {/* Background Image */}
                ...
                <div className="relative max-w-screen w-full mx-auto ">
                    ...
                    <div className="p-8">
                        ...
                        {/* Award Images */}
                        <div className="award-badge flex justify-center items-center gap-6">
                            ...
                            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/global-search-awards.png?w=1600&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=0.5&fp-y=0.5&dm=1750847622&s=e8a73a992886da0dda58fc12cfeb588f" className="w-10" />
                            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Mask-group.png?w=1600&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=0.5&fp-y=0.5&dm=1750847620&s=3b946ebdec8c5ba9fdba897c87d89fea" className="w-10" />
                            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Awards/White/UKSocial-Media-Awards-White.png?w=1600&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=0.5&fp-y=0.5&dm=1750847605&s=0f7ae6a0d6ed51370b560f329b0c621c" className="w-10" />
                            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Awards/White/UK-Content-Awards-White.png?w=1600&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=0.5&fp-y=0.5&dm=1750847605&s=f0f296d2b9e725112abcaae5d6e35922" className="w-10" />
                            <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 fill-current text-white">
